...
import CalorieCalc from '../images/calorie calculator img.PNG'
    ...
    return (
      ...
      <main className="row">
        <div className="card-deck">
          ...
          <div className="card">
            ...
            <section className="card-body">
              ...
              <p className="card-text">
                ...
                plan based on the goal they selected. I also put in functionality
                that a user can use to search a database for a specific food item
                and its nutrition information. Technologies: Javascript, jQuery, Zurb Foundation, Nutritionix API, and FoodData Central API
              </p>
            </section>
            <div className="card-footer">
              <a
          ...
          <div className="card">
            <a href="https://forage-mealplan.herokuapp.com/" target="_blank">
              <img
            ...
            <section className="card-body">
              ...
              <p className="card-text">
                Life is hard. Being healthy should be easy. That's why we created
                Forage. A social meal planning ecosystem that allows you to build
                custom meal plans and share it with your friends to keep everyone
                on the path to optimal health. Technologies: Javascript, jQuery,
                Materialize, Edamam API, Handlebars, MySQL, NodeJS, and Express.js
              </p>
            </section>
            <div className="card-footer">
              <a
