...
<div id="background-img">
    <main className="container bg-light shadow-lg p-1 mb-2 rounded">
      <header>
        <h1 id="header" className="text-center bg-white rounded shadow">
          About Me
          <small className="text-muted">"The Coding Dietitian"</small>
        </h1>
      </header>
      <section className="row text-center">
        <div id="img" className="col-12">
          ...
          <p id="bio" className="m-2 text-center shadow-lg p-3 bg-white rounded">
            <strong>
              ...
              pushed me to furthur my skill set and learn software development.
              With this knowledge I can combine my two passions and help
              craft the future of technology.
            </strong>
          </p>
        </div>
      </section>
